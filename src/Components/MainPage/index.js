      ...
      <div>
        <div className="main-content">
          <div className="sidebar">
            <NavbarBrand href="/">Your Favorite Memes Provider</NavbarBrand>
            <p>
              Please Help Us To Keep Our Business
            </p>
            <p>
              Create Memes To Help Our Bot Gets Better at Selecting Memes !
            </p>
            <p>
              <a href="https://memes.hassanlab.com">Subscribe</a>
            </p>
            <p>
              <a href="https://memes.hassanlab.com">Make a Donation</a>
            </p>
          </div>
        ...
        <Modal className="meme-gen-modal" isOpen={this.state.modalIsOpen}>
          <ModalHeader toggle={this.toggle}>Your Favorite Memes Provider</ModalHeader>
          <ModalBody>
            <svg
              width={newWidth}
              id="svg_ref"
